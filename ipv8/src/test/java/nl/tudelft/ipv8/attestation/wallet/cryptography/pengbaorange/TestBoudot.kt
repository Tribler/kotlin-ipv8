...
class TestBoudot {
    ...
    private val pk = BonehPublicKey(
        p = BigInteger("1855855294356961364177"),
        g = FP2Value(
            mod = BigInteger("1855855294356961364177"),
    ...
    private val bitSpace = 32
    private val a = 0.toBigInteger()
    private val b = 18.toBigInteger()
    private val r = 2.toBigInteger()
    private val ra = 3.toBigInteger()
    ...
    fun ELSerializationTest() {
         ...
         */
        val el = EL(
            BigInteger("68174117739048401651990398043836840253231911962332258219191049320869958258614"),
    ...
    fun SQRSerializationTest() {
         ...
         */
        val el = EL(
            BigInteger("77692238748522549651683873494184958254240308467748145113388211342290056191907"),
