...
class HalfBlockPairBroadcastPayloadTest {
    @Test
    fun serializeAndDeserialize() {
        ...
        val payload = HalfBlockPairBroadcastPayload(block1, block2, 2u)
        val serialized = payload.serialize()

        val (deserialized, size) = HalfBlockPairBroadcastPayload.deserialize(serialized)
